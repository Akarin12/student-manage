...
public class AliOSSUtil {
    ...
    public static String ossUpload(File file) {
        String bucketDomain = "https://niit-ty.oss-cn-shanghai.aliyuncs.com/";
        //Endpoint以北京为例，其它Region请按实际情况填写
        String endpoint = "http://oss-cn-shanghai.aliyuncs.com";
        //accessKeyId和accessKeySecret，请填写自己的
        String accessKeyId = "LTAIXufI7jw7AOaE";
        String accessKeySecret = "RnloSVn5jZ30hwdjhkASQPryeUO75P";
        //Bucket名称
        String bucketName = "niit-ty";
        //目录名称
        String filedir = "student-manage/img/logo/";
        //获得本地文件的文件名
    ...
    public static void main(String[] args) {
        File file = new File("D:/32fd0f42cdf8495780660da64a371ea2.gif");
